...
<Link class="nav-link disabled" to="/Chats" >Chats</Link>|{" "}
<Link class="nav-link disabled" to="/Specialist" >Specialist</Link>|{" "}
<Link class="text-muted" to="/AllSpecialistAdmin">AllSpecialist</Link>|{" "}
<Link class="nav-link disabled" to="/Post" >Post</Link>|{" "}
<Link class="text-muted"  to="/AllPost">AllPost</Link>|{" "}
<Link class="nav-link disabled" to="/PersonalExperience"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square-fill" viewBox="0 0 16 16">
  <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm6.5 4.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3a.5.5 0 0 1 1 0z" />
</svg></Link>|{" "}
<Link class="nav-link disabled"  to="/AllPersonalExperience">AllPersonalExperience</Link>|{" "}
...
<Outlet />
  ...
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
          ...
          <Link    to="/Chats" disabled>Chats</Link>|{" "}
    ...
    <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
          ...
          <Link class="text-muted" to="/AllPersonalExperience">AllPersonalExperience</Link>|{" "}
          <Link class="text-muted" to="/AllComments">AllComments</Link>|{" "}
        </nav>
        <Outlet />
      </div>
    );
